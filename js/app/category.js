    ...
    sidebar_register() {
        g_sidebar.register('left', {
            html: `<div>
                ...
                <div id="group_list" class="p-2 pt-0 overflow-x-hidden overflow-y-auto" style="height: calc(100vh - 150px);"></div>

                <div class="d-flex w-full position-absolute bottom-0 p-2">
                    <a title="插件" class="btn btn-pill btn-ghost-primary" href="#dropdown-plugin" data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button" aria-expanded="false"><i class="ti ti-plug"></i></a>
    ...
    item_html(name, group, item, action = '') {
        return `
            <div class="row align-items-center m-1">
                <a class="list-group-item list-group-item-action col" data-action="${action}" data-list="${group}" data-name="${name}">
